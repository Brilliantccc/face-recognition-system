...
### 人事管理模块 (admin/)
- 员工信息录入（姓名、工号、部门、电话）
- 工作照片管理（上传/预览/清除，自动人脸检测绘制方框）
- 人脸训练数据录入（摄像头拍摄/本地上传，独立于工作照片）
- 员工信息查询和管理
...
# 工作照片目录
WORK_PHOTOS_DIR = "data/work_photos"
...
1. 启动人事管理系统 → 添加员工 → 上传工作照片 → 录入人脸训练数据
2. 启动门禁系统 → 自动识别
...
- **2026-07-15**: 新增工作照片管理功能，移除管理界面中的训练数据管理
